...
class DataGenerator(object):
    ...
    def __init__(self, hdf5_path, batch_size, dev_train_csv=None,
        ...
        self.device = np.array([lb_to_ix_domain[lbd] for lbd in self.source_labels])
    ...
    def generate_train(self):
        ...
        while True:
            ...
            batch_device = self.device[batch_audio_indexes]

            # Transform data
            batch_x = self.transform(batch_x)

            yield batch_x, batch_y, batch_device
    ...
    def generate_validate(self, data_type, devices, shuffle, 
        ...
        while True:
            ...
            yield batch_x, batch_y, batch_audio_names, batch_device
